                        ...
                        <div className="mainContent col-sm-7">
                            <div className="bag mb-4">
                                <div className="head d-flex justify-content-between align-items-end mb-1 px-2">
                                    ...
                                    <div className="viewmore" type="button" value="like_count desc" onClick={viewMore("like_count desc")}>
                                        View more...
                                    </div>
                                </div>
                            ...
                            <div className="bag mb-4">
                                <div className="head d-flex justify-content-between align-items-end mb-1 px-2">
                                    ...
                                    <div className="viewmore" type="button" value="created_at desc" onClick={viewMore("created_at desc")}>
                                        View more...
                                    </div>
                                </div>
                                <div class="card-group">
