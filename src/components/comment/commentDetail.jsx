        ...
        <>
            <div className="container-sm border rounded-3 mb-3">
                <div className="d-flex bd-highlight mb-1">
                    ...
                    <div className="ms-auto p-2 bd-highlight">
                        <div className="ms-auto p-2 bd-highlight d-flex justify-content-end">
                            ...
                            <img src={threeDots} alt="threeDots" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false"/>
                            <ul className="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                <li><a className="dropdown-item" onClick={()=> setEditComment(true)}>Edit</a></li>
                ...
                <div className="d-flex justify-content-end">
                    {data.subComment.map((item, index) => <SubComments data={item} key={index}/>)}
                </div>
                {subComment ? 
                    <div className="d-flex justify-content-end">
                        <CreateComments />
