                    ...
                    <div className={`modal-content mx-auto ${styles.radius}`}>
                        ...
                        <div className="modal-body mx-4">
                            <div>
                                ...
                                <input className={`form-control rounded-pill my-4`} type="text" placeholder="example@example.com" />
                            </div>
                            <div>
                                <h6 className="fw-bold  ms-1  my-2">Password</h6>
                                <input className={`form-control rounded-pill my-4`} type="password" placeholder="example123" />
                            </div>
                        </div>
                    ...
                    <div className={`${styles.wrap} d-flex align-items-center`}>
                        <div className={`dropdown me-4`}>
                            ...
                            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li>
                                    <a className="dropdown-item text-reset" data-bs-toggle="modal" data-bs-target="#ModalLogout" href="#">
                                        Logout
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div className="modal-dialog modal-dialog-centered">
                                <div className={`modal-content mx-auto ${styles.radius}`}>
                                    ...
                                    <div className="modal-body mx-4 d-flex flex-column align-items-center">
                                        ...
                                        <div>
                                            <button type="button" className={`btn btn-danger rounded-pill mx-auto me-2`}>
                                                Yes
                                            </button>
                                            <button type="button" className={`btn btn-primary rounded-pill mx-auto`}>
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
