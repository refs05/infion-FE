...
const Header = () => {
    const [cookies, setCookies, removeCookies] = useCookies(["username", "id", "role_id", "token"]);
    ...
    const validate = (e) => {
        ...
        if (errMsg == def && emailusrRgs != "" && username != "" && passRgs != "" && passConf != "") {
            setRgsBtnStat("");
        }
    };
            ...
            axios
                ...
                .then(function (response) {
                    if (response.data.data.id == 0) {
                        ...
                        Swal.fire("Success Create New User!", "Hello" + " " + response.data.data.username, "Please Login With Your New Account");
                    }
                })
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const { data: response } = await axios.get(`http://localhost:8000/announcements/list`);
    ...
    return (
        <div className="bg-hitam">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav m-auto">
                            <li className="nav-item mx-sm-5">
                                <Link to={`/`} className={styles.link}>
                                    <a className="nav-link active text-reset" aria-current="page" href="/">
                                        Home
                                    </a>
                                </Link>
                            </li>
                            ...
                            {usernameStatus ? (
                                ...
                                <li className="nav-item  mx-sm-5">
                                    <a className="nav-link text-reset" href="#" data-bs-toggle="modal" data-bs-target="#ModalUnlogged">
                                        Make Own Threads
                                    </a>
                                    <div
                        ...
                        {usernameStatus ? (
                            <>
                                <ul className="navbar-nav">
                                    <div className={`${styles.wrap} d-flex align-items-center me-5`}>
                                        <div className={`dropdown me-4`}>
                                            <div
                                                ...
                                                aria-expanded="false"
                                            >
                                                <img src={cookies.url_img} alt="" className={`${styles.profileSize}`} />
                                            </div>
                                            <ul className="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="dropdownMenuButton1">
                                                {cookies.role_id == 1 ? (
                                                    <>
                                                        {" "}
                                                        <li>
                                                            <Link to={`/profile/${cookies.id}`} className={`${styles.clearDecoration}`}>
                                                        ...
                                                        <li>
                                                            <Link to={`/yourThreads/${cookies.id}`} className={`${styles.clearDecoration}`}>
                                                                <a className="dropdown-item" href="#">
                                                                    Your Thread
                                                                </a>
                                                            </Link>
                                                    ...
                                                    <>
                                                        ...
                                                        <li>
                                                            <Link to={`/admin`} className={`${styles.clearDecoration}`}>
                                                                <a className="dropdown-item" href="#">
                                                                    Management
                                                                </a>
                                                            </Link>
                                            ...
                                            <div className="modal-dialog modal-dialog-centered">
                                                <div className={`modal-content mx-auto ${styles.radius}`}>
                                                    <div className="modal-header">
                                                        <h4 className="modal-title mx-auto fw-bolder" id="exampleModalLabel">
                                                            Logout
                                                        </h4>
                                                    </div>
                                        ...
                                        <div className="dropdown me-4">
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                {data?.slice(0, 8).map((item, index) => (
                                                    <>
                                                        <li key={index} onClick={getAnnounce(item.announcer, item.message)}>
                                                            <a
                                                                href="#"
                                                                className="dropdown-item text-reset"
                                                                data-bs-toggle="modal"
                                        ...
                                        >
                                            <div className="modal-dialog modal-dialog-centered">
                                                <div className={`modal-content mx-auto ${styles.announce}`}>
                                                    <div className={`modal-header ${styles.headerAnnounce}`}>
                                                        <h5 className="modal-title" id="exampleModalLabel">
                                                            From : {dataAnnounce.user}
                                                        </h5>
                                                    </div>
                                                    <div className={`modal-body d-flex flex-column ${styles.bodyAnnounce}`}>
                    ...
                    />
                            ...
                            <ul className="navbar-nav">
                                <li className="nav-item me-sm-3">
                                    <a className="nav-link text-reset" data-bs-toggle="modal" data-bs-target="#ModalLogin" href="#">
                                        Login
                                    </a>
                                </li>
                                <li className="nav-item me-sm-5">
                                    <a className="nav-link text-reset" data-bs-toggle="modal" data-bs-target="#ModalRegister" href="#" href="#">
                                        Register
                                    </a>
                                </li>
                            </ul>
            ...
            <div className={`modal fade textBlack `} id="ModalLogin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className={`modal-content mx-auto ${styles.radius}`}>
                        <div className="modal-header">
                            <h4 className="modal-title mx-auto fw-bolder" id="exampleModalLabel">
                        ...
                        <input type="hidden" id="custId" onChange={() => respon} value={response} />
                        <br />
                        <div className="mx-auto">
                            <p className={`${styles.grey}`}>
                                Don't have an account ?{" "}
                                <a href="#" className={`${styles.blue}`} data-bs-toggle="modal" data-bs-target="#ModalRegister">
                                    Register
                                </a>
                            </p>
                        </div>
            ...
            <div className={`modal fade textBlack `} id="ModalRegister" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div className={`modal-content mx-auto ${styles.radius2}`}>
                        ...
                        <div className="mx-auto">
                            <div class="form-check">
                                ...
                                <label className={`${styles.grey}`} for="defaultCheck1" data-bs-dismiss="modal" aria-label="Close">
                                    I agree with{" "}
                                    <Link to="/agreement">
